			...
			<div class="mainmechaCon_RoClass" id="pageContentsWrap" style="border: 2px solid yellow;">
				...
				<div class="mainmechaCon_RoClass" id="mainContentWrap" style="border: 2px solid red;">
					...
					<div class="mainmechaCon_RoClass" id="featuresControlsWrap" style="border: 2px solid blue; display: none;">
						...
						<div class="mainmechaCon_RoClass featuresControls">							
							...
							<div class="mainmechaCon_RoClass featuresTextWrap">
								...
								<div class="mainmechaCon_RoClass featuresTextDefinition lightMode">lorem ipsum lorem ipsum lorem ipsum</div>
							</div>							
						</div>	
						<!--Committees feature controller-->
						...
						<div class="mainmechaCon_RoClass featuresControls">							
							...
							<div class="mainmechaCon_RoClass featuresTextWrap">
								<div class="mainmechaCon_RoClass featuresTextTitle lightMode">Pinned Post</div>
								<div class="mainmechaCon_RoClass featuresTextDefinition lightMode">lorem ipsum lorem ipsum lorem ipsum lorem ipsumlorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum</div>
							</div>							
						</div>	
						<!--Pinned Post feature controller-->					
					</div>
					...
					<div class="mainmechaCon_RoClass" id="featuresWrap" style="border: 2px solid blue;">
						...
						<!--What is new posts-->
						<div class="mainmechaCon_RoClass perFeature" id="whatIsNewSection" style="border: 2px solid orange; display: none;">
							<div class="mainmechaCon_RoClass sectionsLabel lightMode" style="border: 2px solid gray;">What's New</div>
				...
				<div class="mainmechaCon_RoClass lightMode" id="chatContentWrap" style="border: 2px solid red;">
					Chat side
				</div>
				<!--Right Side or Chat Area-->
			</div>
